...
- Create Angular project with ng: `ng new documentupload.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`documentupload.client.esproj`).
